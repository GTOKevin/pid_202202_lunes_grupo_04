...
USE [DB_INMOBILIARIA]
GO
/****** Object:  Table [dbo].[DEPARTAMENTO]    Script Date: 19/6/2022 21:40:32 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[DEPARTAMENTO_FILE]    Script Date: 19/6/2022 21:40:33 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ESTADO]    Script Date: 19/6/2022 21:40:33 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[INCIDENTE]    Script Date: 19/6/2022 21:40:33 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[INCIDENTE_FILE]    Script Date: 19/6/2022 21:40:33 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[INCIDENTE_HISTORIAL]    Script Date: 19/6/2022 21:40:33 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PERFIL]    Script Date: 19/6/2022 21:40:33 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PERFIL_FILE]    Script Date: 19/6/2022 21:40:33 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[PERFIL_FILE](
	[id_file] [int] IDENTITY(1,1) NOT NULL,
	[nombrefile] [varchar](max) NULL,
	[id_perfil] [int] NULL,
 CONSTRAINT [PK_PERFIL_FILE] PRIMARY KEY CLUSTERED 
(
	[id_file] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
GO
/****** Object:  Table [dbo].[PROPIETARIO]    Script Date: 19/6/2022 21:40:33 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[RECIBO]    Script Date: 19/6/2022 21:40:33 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ROL]    Script Date: 19/6/2022 21:40:33 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[SECTOR]    Script Date: 19/6/2022 21:40:33 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[SUCURSAL]    Script Date: 19/6/2022 21:40:33 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TIPO]    Script Date: 19/6/2022 21:40:33 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TORRE]    Script Date: 19/6/2022 21:40:33 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[USUARIO]    Script Date: 19/6/2022 21:40:33 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[VISITA_REGISTRO]    Script Date: 19/6/2022 21:40:33 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[VISITANTE]    Script Date: 19/6/2022 21:40:33 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
ALTER TABLE [dbo].[PERFIL_FILE]  WITH CHECK ADD  CONSTRAINT [FK_PERFIL_FILE_PERFIL] FOREIGN KEY([id_perfil])
REFERENCES [dbo].[PERFIL] ([id_perfil])
GO
ALTER TABLE [dbo].[PERFIL_FILE] CHECK CONSTRAINT [FK_PERFIL_FILE_PERFIL]
GO
...
GO
ALTER TABLE [dbo].[RECIBO]  WITH CHECK ADD  CONSTRAINT [FK_RECIBO_DEPARTAMENTO] FOREIGN KEY([id_departamento])
REFERENCES [dbo].[DEPARTAMENTO] ([id_departamento])
GO
ALTER TABLE [dbo].[RECIBO] CHECK CONSTRAINT [FK_RECIBO_DEPARTAMENTO]
GO
